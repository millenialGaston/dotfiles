...
(bind-key (kbd "M-p s") 'org-insert-subheading)
#+END_SRC
...
(setq org-capture-templates
      '(("t" "Todo" entry (file+headline "~/.personal/org/todo.org" "tasks")
        ...
        ("w" "wiki-link" entry (file+headline "~/meta-wiki/mywiki/index.org" "inbox")
...
(use-package org-brain
  :init
  (setq org-brain-path "~/meta-wiki/mywiki/")
  ;; For Evil users
